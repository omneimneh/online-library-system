...
VALUES('A Brief History of Time', 'A Brief History of Time: From the Big Bang to Black Holes is a popular-science book on cosmology by British physicist Stephen Hawking. It was first published in 1988. Hawking wrote the book for nonspecialist readers with no prior knowledge of scientific theories.', @A1, '3-1-1988', @P1)

INSERT INTO Book(BookTitle, BookDescription, AuthorId, PublishingDate, PublisherId)
VALUES('Relativity: The Special and the General Theory', 'Relativity: The Special and the General Theory began as a short paper and was eventually published as a book written by Albert Einstein', @A2, '1-1-1916', NULL)

INSERT INTO Book(BookTitle, BookDescription, AuthorId, PublishingDate, PublisherId)
VALUES('Code Complete', 'Code Complete is a software development book, written by Steve McConnell and published in 1993 by Microsoft Press, encouraging developers to continue past code-and-fix programming and the big design up front and waterfall models.', @A3, '1-1-1993', @P3)

INSERT INTO Book(BookTitle, BookDescription, AuthorId, PublishingDate, PublisherId)
VALUES('Operating System Concepts', 'New edition of the bestseller provides readers with a clear description of the concepts that underlie operating systems', @A4, '1-1-1982', @P1)
...
INSERT INTO Book(BookTitle, BookDescription, AuthorId, PublishingDate, PublisherId)
VALUES('The Selfish Gene', 'The Selfish Gene is a 1976 book on evolution by Richard Dawkins, in which the author builds upon the principal theory of George C. Williams''s Adaptation and Natural Selection.', @A9, '1-1-1976', @P3)

INSERT INTO Book(BookTitle, BookDescription, AuthorId, PublishingDate, PublisherId)
VALUES('Molecular Biology of the Cell', 'Molecular Biology of the Cell is a cellular and molecular biology textbook published by Garland Science and currently authored by Bruce Alberts, Alexander D. Johnson, Julian Lewis, David Morgan, Martin Raff, Keith Roberts and Peter Walter. The book was first published in 1983 and is now in its sixth edition.', @A10, '1-1-1983', @P1)

INSERT INTO Book(BookTitle, BookDescription, AuthorId, PublishingDate, PublisherId)
VALUES('Business Law', 'A summarized case version of the best-selling title for this course.', @A11, '1-1-2005', @P2)

INSERT INTO Book(BookTitle, BookDescription, AuthorId, PublishingDate, PublisherId)
VALUES('To Kill a Mockingbird', 'To Kill a Mockingbird is a novel by Harper Lee published in 1960. Instantly successful, widely read in high schools and middle schools in the United States, it has become a classic of modern American literature winning the Pulitzer Prize.', @A12, '7-11-1960', @P3)